...
var QHeader = createComponent({
  ...
  setup(props, { slots, emit }) {
    ...
    const offset2 = computed(() => {
      ...
      const offset3 = size.value - $layout.scroll.value.position;
...
const _hoisted_2 = { class: "absolute-center row t-text-20 t-pt-5" };
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("div", { class: "q-ml-xs" }, "1", -1);
const _hoisted_4 = /* @__PURE__ */ createBaseVNode("div", { class: "q-ml-md t-mr-14" }, "=", -1);
...
const _sfc_main = defineComponent({
  ...
  setup(__props) {
    ...
    async function getDivineValue() {
      ...
      lastFetchAt.value = hooks().format("YYYY-MM-DD HH:mm");
    }
    return (_ctx, _cache) => {
                ...
                default: withCtx(() => [
                  createBaseVNode("div", {
                    ...
                    createVNode(QToolbarTitle, {
                      ...
                      onClick: _cache[0] || (_cache[0] = ($event) => _ctx.$router.push({ name: "main" }))
                    }, {
                      default: withCtx(() => [
                        createTextVNode(" POE PLAY "),
                        _hoisted_1
                      ]),
                      _: 1
                    }),
                  ...
                  createBaseVNode("div", _hoisted_2, [
                    ...
                    createBaseVNode("div", _hoisted_5, toDisplayString(unref(store).CHAOS_PER_DIVINE), 1),
                    createBaseVNode("div", _hoisted_6, "( " + toDisplayString(lastFetchAt.value) + " )", 1)
                  ])
                ]),
                _: 1
              })
