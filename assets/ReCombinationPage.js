...
import { h, c as createComponent, k as isRuntimeSsrPreHydration, r as ref, v as onMounted, w as watch, a as computed, i as inject, o as onBeforeUnmount, af as formKey, g as getCurrentInstance, ag as debounce, W as injectProp, ah as onBeforeUpdate, $ as stopAndPrevent, G as nextTick, M as onDeactivated, ai as onActivated, R as prevent, ad as QIcon, O as QSpinner, d as hSlot, T as Transition, aj as shouldIgnoreKey, _ as client, ak as stop, al as createDirective, F as noop, am as leftClick, S as addEvt, an as preventDraggable, ao as position, U as cleanEvt, q as hMergeSlot, a6 as withDirectives, s as defineComponent, y as openBlock, z as createBlock, A as withCtx, C as createBaseVNode, B as createVNode, Q as QBtn, a3 as createCommentVNode, a0 as createElementBlock, a5 as renderList, a1 as Fragment, a2 as toDisplayString, a8 as pushScopeId, a9 as popScopeId } from "./index.js";
import { b as addFocusFn, u as useDarkProps, d as useDark, e as removeFocusFn, f as useFormProps, g as useFormInputNameAttr, c as clearSelection, _ as _export_sfc, Q as QCheckbox } from "./plugin-vue_export-helper.js";
...
function useId({ getValue: getValue2, required = true } = {}) {
  ...
  return getValue2 !== void 0 ? computed(() => getId(getValue2(), required)) : ref(`f_${uid$1()}`);
}
