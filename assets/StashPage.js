...
class Scarab {
  ...
  static async fetch() {
    ...
    const response = await api.get(`https://www.logisnet.co.kr/dev-api/poe/Scarab/${"Mirage"}`);
...
var ScarabItem = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-687826ef"]]);
...
const _sfc_main$d = defineComponent({
  ...
  setup(__props) {
    ...
    const scarabGroupsVertical = ref([]);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createBaseVNode("div", _hoisted_3$6, [
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(scarabGroupsVertical.value, (group, index) => {
            return openBlock(), createElementBlock("div", {
              key: index,
              class: normalizeClass(["column scarab-group", group.class]),
              style: normalizeStyle({ top: `${group.top}`, left: `${group.left}` })
            }, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(group.list, (scarab, sIndex) => {
                return openBlock(), createBlock(ScarabItem, {
...
var ScarabTab = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-ca760abe"]]);
class Allflame {
  constructor() {
    __publicField(this, "id", "");
    __publicField(this, "name", "");
  ...
  static async fetch() {
    ...
    const response = await api.get(`https://www.logisnet.co.kr/dev-api/poe/AllflameEmber/${"Mirage"}`);
    const priceRes = response.data.lines;
    const iconRes = response.data.items;
    priceRes.forEach((data) => {
      list.forEach((item) => {
    ...
    const responseF = await api.get(`https://www.logisnet.co.kr/dev-api/poe/Fragment/${"Mirage"}`);
...
class Fossil {
  ...
  static async fetch() {
    ...
    const response = await api.get(`https://www.logisnet.co.kr/dev-api/poe/Fossil/${"Mirage"}`);
    const priceRes = response.data.lines;
    const iconRes = response.data.items;
    priceRes.forEach((data) => {
      list.forEach((fossil) => {
...
class Resonator {
  ...
  static async fetch() {
    ...
    const response = await api.get(`https://www.logisnet.co.kr/dev-api/poe/Resonator/${"Mirage"}`);
    const priceRes = response.data.lines;
    const iconRes = response.data.items;
    priceRes.forEach((data) => {
...
class Oil {
  ...
  static async fetch() {
    ...
    const response = await api.get(`https://www.logisnet.co.kr/dev-api/poe/Oil/${"Mirage"}`);
    const priceRes = response.data.lines;
    const iconRes = response.data.items;
    priceRes.forEach((data) => {
      list.forEach((oil) => {
...
class DeliriumOrb {
  ...
  static async fetch() {
    ...
    const responseD = await api.get(`https://www.logisnet.co.kr/dev-api/poe/DeliriumOrb/${"Mirage"}`);
